...
import {
  useNominationsContext,
  NominationsContext,
} from "./nominationsContext";
import type * as Fetcher from "./nominationsFetcher";
import { nominationsFetch } from "./nominationsFetcher";
import type * as Responses from "./nominationsResponses";
...
export const useCubeAcademyLogin = (
  ...
  const { fetcherOptions } = useNominationsContext();
